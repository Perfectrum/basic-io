...
internal class SvHandlerFileTest {
    ...
    fun airtrvelTest() {
        ...
        val tableFromFile = SvHandler.Companion.readCsvTable(
            Paths.get("./src/test/resources/tables/airtravel.csv")
        )
    ...
    fun biostatsTest() {
        ...
        val tableFromFile = SvHandler.Companion.readCsvTable(
            Paths.get("./src/test/resources/tables/biostats.csv")
        )
    ...
    fun crash_cataloniaTest() {
        ...
        val tableFromFile = SvHandler.Companion.readCsvTable(
            Paths.get("./src/test/resources/tables/crash_catalonia.csv")
        )
    ...
    fun hooke() {
        ...
        val tableFromFile = SvHandler.Companion.readCsvTable(
            Paths.get("./src/test/resources/tables/hooke.csv")
        )
    ...
    fun tally_cabTest() {
        ...
        val tableFromFile = SvHandler.Companion.readCsvTable(
            Paths.get("./src/test/resources/tables/tally_cab.csv")
        )
