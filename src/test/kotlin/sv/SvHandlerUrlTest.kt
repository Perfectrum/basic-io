...
internal class SvHandlerUrlTest {
    ...
    fun airtravelTest() {
        ...
        val tableFromUrl = SvHandler.readCsvTable(
            URL("https://people.sc.fsu.edu/~jburkardt/data/csv/airtravel.csv")
        )

        assertEqualsTables(tableFromString, tableFromUrl)
    }
    ...
    fun hookeTest() {
        ...
        val tableFromUrl = SvHandler.readCsvTable(
            URL("https://people.sc.fsu.edu/~jburkardt/data/csv/hooke.csv")
        )
    ...
    fun tally_cabTest() {
        ...
        val tableFromUrl = SvHandler.readCsvTable(
            URL("https://people.sc.fsu.edu/~jburkardt/data/csv/tally_cab.csv")
        )
